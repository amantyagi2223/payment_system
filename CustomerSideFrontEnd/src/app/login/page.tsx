      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">
            Login to continue to CryptoMarket
          </p>
        </div>

        <div className="bg-slate-900/80 backdrop-blur-2xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-white bg-slate-800/80 border border-slate-700 rounded-xl pl-12 pr-4 py-3.5 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all placeholder:text-slate-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-white bg-slate-800/80 border border-slate-700 rounded-xl pl-12 pr-12 py-3.5 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all placeholder:text-slate-500"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-600 via-purple-600 to-cyan-600 bg-size-200 hover:bg-pos-0 font-semibold text-white transition-all duration-300 shadow-lg shadow-cyan-600/20 hover:shadow-cyan-600/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
          <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-xl p-4 text-center">
